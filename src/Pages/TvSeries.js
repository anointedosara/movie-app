...
function TvSeries() {
    ...
    const getGenreMovies = async () => {
      fetch(`https://api.themoviedb.org/3/discover/tv?api_key=7d8950b413b70f01371c062f2f50f32d&language=en-US&sort_by=popularity
  ...
  return (
    <div className='tvseries'>
      ...
      {showModal && <Modal id={modalData.id} type='tv' closeModal={() => setShowModal(false)} />}
    </div>
  )
}
